...
/* Uniones.
El programa muesra la manera como se declara una union, asi como la forma de
acceso a los campos de las variables de toipo union para asignacion
de valores como para lectura y escriura. */
...
void Lectura(alumno a);    /* Declaracion de una estructura utilizando typedef. */
