...
la variable cad0 -apuntador de tipo cadena de caraceres. */
pus(cad0);
...
función de lectura gets, es necesario iniciarlo como se hace en la siguiente
instrucción. */
...
que existe con este. Aqui se produce un error en la compilación del programa,
