...
alumnos, obtiene la frecuenciade cada una de las calificaciones y además
...
/* Esta función obtiene la primera ocurrencia de la frecuencia mas alta. */
{
...
printf("\n\nMayor frecuencia de calificiones: %d \tValor: %d", MFRE, MVAL);
}
