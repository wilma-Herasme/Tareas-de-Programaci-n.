...
/* La función Suma regresa de los parametros de tipo entero
X y Y. */
{
    return (X+Y);
}
...
/* Esta función recibe como parámetro otra función -la direccion- y
dependiendo de cual sea esta, llama a la función Suma o Resta. */
{
int RES;
